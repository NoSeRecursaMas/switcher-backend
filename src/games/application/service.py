...
class GameService:
    def __init__(self, game_repository: GameRepository, player_repository: PlayerRepository, room_repository: RoomRepository):
    ...
    async def start_game(self, roomID: int, playerID: PlayerID) -> GameID:
        ...
        await self.room_domain_service.validate_player_is_not_owner(playerID, roomID)
        ...
        game_service_domain = GameServiceDomain(
            self.game_repository, self.player_repository)
